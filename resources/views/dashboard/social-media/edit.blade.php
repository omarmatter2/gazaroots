...
<div class="container-fixed p-5">
    ...
    <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
        <div class="flex flex-col justify-center gap-2">
            <h1 class="text-xl font-semibold leading-none text-mono">Edit Social Media</h1>
    ...
    <form action="{{ route('admin.social-media.update', $socialMedia) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="kt-card">
            <div class="kt-card-content p-7.5">
                <div class="grid gap-5 lg:gap-7.5">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="text" class="kt-input" id="platform" name="platform" value="{{ old('platform', $socialMedia->platform) }}"
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="url" class="kt-input" id="url" name="url" value="{{ old('url', $socialMedia->url) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="kt-form-label">Icon Image</label>
                            <label class="flex flex-col items-center justify-center w-32 h-32 border-2 border-dashed border-border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors">
                                @if($socialMedia->image)
                                    <div class="hidden" id="image-placeholder">
                                    ...
                                    <img id="image-preview" class="w-full h-full object-contain rounded-lg p-2" src="{{ $socialMedia->image_url }}" alt="Preview">
                                @else
                                ...
                                @endif
                                <input type="file" name="image" accept=".svg,.png,.jpg,.jpeg,.webp" class="hidden" onchange="previewImage(this, 'image-preview', 'image-placeholder')">
                            </label>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <label class="flex flex-col items-center justify-center w-32 h-32 border-2 border-dashed border-border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors">
                                @if($socialMedia->hover_image)
                                    <div class="hidden" id="hover-placeholder">
                                        <i class="ki-filled ki-picture text-3xl text-muted-foreground mb-2"></i>
                                        <span class="text-xs text-secondary-foreground">Click to upload</span>
                                    </div>
                                    <img id="hover-preview" class="w-full h-full object-contain rounded-lg p-2" src="{{ $socialMedia->hover_image_url }}" alt="Preview">
                                @else
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <input type="number" class="kt-input" id="order" name="order" value="{{ old('order', $socialMedia->order) }}" min="0">
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex items-center gap-2.5">
                                ...
                                <input type="checkbox" class="kt-switch" name="is_active" value="1" {{ old('is_active', $socialMedia->is_active) ? 'checked' : '' }}>
            ...
            <div class="kt-card-footer flex justify-end gap-2.5 p-7.5 border-t border-border">
                ...
                <button type="submit" class="kt-btn kt-btn-primary">Update Social Media</button>
            </div>
        </div>
    </form>
</div>
