      ...
      <div class="flex items-center gap-2.5">
       ...
       <div class="shrink-0" data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
        <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
         <div class="size-9 rounded-full border-2 border-green-500 shrink-0 bg-primary flex items-center justify-center text-white font-semibold">
        ...
        <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
         <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
          <div class="flex items-center gap-2">
           <div class="size-9 shrink-0 rounded-full border-2 border-green-500 bg-primary flex items-center justify-center text-white font-semibold">
            {{ strtoupper(substr(auth()->user()->name ?? 'A', 0, 1)) }}
           </div>
           <div class="flex flex-col gap-1.5">
         ...
         <ul class="kt-dropdown-menu-sub">
          ...
          <li>
           <span class="kt-dropdown-menu-link text-muted-foreground">
          ...
          <li>
           <form action="{{ route('admin.logout') }}" method="POST">
            @csrf
            <button type="submit" class="kt-dropdown-menu-link w-full text-start text-danger hover:bg-danger/10">
