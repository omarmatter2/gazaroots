...
<div class="container-fixed p-5">
    <div class="flex flex-wrap items-center justify-between gap-5 pb-7.5">
        <div class="flex flex-col gap-2">
            <h1 class="text-xl font-semibold text-gray-900">Create Newsletter</h1>
                    ...
                    <div class="kt-card-body space-y-5">
                        <div class="grid grid-cols-2 gap-5">
                            <div class="flex flex-col gap-1">
                                ...
                                <input type="text" class="kt-input" id="subject_en" name="subject[en]" value="{{ old('subject.en') }}" required>
                            </div>
                            <div class="flex flex-col gap-1">
                                <label class="kt-form-label" for="subject_ar">Subject (Arabic) <span class="text-danger">*</span></label>
                                <input type="text" class="kt-input" id="subject_ar" name="subject[ar]" value="{{ old('subject.ar') }}" dir="rtl" required>
                            </div>
                        </div>
                        <div class="flex flex-col gap-1">
                    ...
                    <div class="kt-card-body space-y-5">
                        <div class="flex flex-col gap-3">
                            <label class="flex items-center gap-2.5">
                                <input type="radio" class="kt-radio" name="send_type" value="now" checked>
                            ...
                            <label class="flex items-center gap-2.5">
                                <input type="radio" class="kt-radio" name="send_type" value="scheduled" id="send_type_scheduled">
                                <span class="flex flex-col">
                        ...
                        <div class="flex flex-col gap-1 hidden" id="schedule_container">
                            <label class="kt-form-label" for="scheduled_at">Schedule Date & Time</label>
                            <input type="datetime-local" class="kt-input" id="scheduled_at" name="scheduled_at" value="{{ old('scheduled_at') }}">
                        </div>
