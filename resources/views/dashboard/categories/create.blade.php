...
<div class="container-fixed p-5">
    ...
    <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
        <div class="flex flex-col justify-center gap-2">
            <h1 class="text-xl font-semibold leading-none text-mono">Create Category</h1>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="kt-card">
            <div class="kt-card-content p-7.5">
                <div class="grid gap-5 lg:gap-7.5">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <textarea class="kt-textarea" id="description_en" name="description[en]" rows="3">{{ old('description.en') }}</textarea>
                    </div>

                    <!-- Description AR -->
                    <div class="flex flex-col gap-1">
                        <label class="kt-form-label" for="description_ar">Description (Arabic)</label>
                        <textarea class="kt-textarea" id="description_ar" name="description[ar]" rows="3" dir="rtl">{{ old('description.ar') }}</textarea>
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <label class="flex flex-col items-center justify-center w-32 h-32 border-2 border-dashed border-border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors" id="image-upload-label">
                            ...
                            <input type="file" name="image" accept=".png,.jpg,.jpeg" class="hidden" id="image-input" onchange="previewImage(this)">
                        </label>
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex items-center gap-2.5">
                                ...
                                <input type="checkbox" class="kt-switch" name="show_on_home" value="1" {{ old('show_on_home') ? 'checked' : '' }}>
            ...
            <div class="kt-card-footer flex justify-end gap-2.5 p-7.5 border-t border-border">
                ...
                <button type="submit" class="kt-btn kt-btn-primary">Create Category</button>
            </div>
        </div>
    </form>
</div>
